        ...
        prepareWidgetOptions: async function () {
            if (this.mode === 'edit') {
                ...
                if (this.attrs.options) {
                    ...
                    if (Object.prototype.hasOwnProperty.call(this.attrs.options, 'address_form')) {
                    ...
                    if (Object.prototype.hasOwnProperty.call(this.attrs.options, 'display_name')) {
    ...
    const GplaceAddressAutocompleteField = GplaceAutocomplete.extend({
        ...
        populateAddress: async function (place, parse_address) {
            ...
            _.each(target_fields, (field) => {
                requests.push(
                    this._prepareValue(field.relation, field.name, parse_address[field.name])
                );
            });
            // Set geolocation
        ...
        getFillFieldsType: function () {
            ...
            if (this._isValid && this.address_mode === 'address_format') {
                _.each(this.fillfields, (option) => {
                    _.each(Object.keys(option), (field_customer_geo_location) => {
                        res.push({
                            name: field_customer_geo_location,
                            type: this.record.fields[field_customer_geo_location].type,
                            relation: this.record.fields[field_customer_geo_location].relation,
                        });
                    });
                });
            }
